...
function query_post_type($query) {
  ...
  if( is_category() ) {
    ...
    $post_type = get_query_var('navpost');
    ...
    if($post_type)
        ...
        $post_type = array('nav_menu_item', 'post', 'navpost'); // don't forget nav_menu_item to allow menus to work!
...
function carlozahar_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('carl_body_link', array(
	...
	$wp_customize->add_setting('carl_body_link_visited', array(
	...
	$wp_customize->add_setting('carl_body_link_active', array(
	...
	$wp_customize->add_section('carloz_bg_colors', array(
		...
		'title' => __('Valucre Backgrounds', 'Carlozahar'),
	...
	$wp_customize->add_section('carloz_slicknav_colors', array(
		...
		'title' => __('Valucre Slicknav', 'Carlozahar'),
	...
	$wp_customize->add_section('carloz_single_post', array(
		...
		'title' => __('Valucre Single Post Styles', 'Carlozahar'),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'carloz_body_link_control', array(

		'label' => __('Body Link Color', 'Carlozahar'),

		'section' => 'carloz_bg_colors',

		'settings' => 'carl_body_link',

		)));

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'carloz_body_link_visited_control', array(

		'label' => __('Visited Body Link Color', 'Carlozahar'),

		'section' => 'carloz_bg_colors',

		'settings' => 'carl_body_link_visited',

		)));

	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'carloz_body_link_active_control', array(

		'label' => __('Active Body Link Color', 'Carlozahar'),

		'section' => 'carloz_bg_colors',

		'settings' => 'carl_body_link_active',
...
function carlozahar_customize_css() { ?>
	...
	<style type="text/css">
		...
		div#front-main, #posts-divider:after {
		...
		.post-body a, .post-body a:link, .box-content.r-content a,
		.box-content.r-content a:link {
			color: <?php echo get_theme_mod('carl_body_link', '#FFE600'); ?>;
		}

		.post-body a:visited, .box-content.r-content a:visited {
			color: <?php echo get_theme_mod('carl_body_link_visited', '#ecd34c'); ?>;
		}

		 .post-body a:active, .box-content.r-content a:active,
		 .post-body a:hover, .box-content.r-content a:hover {
			color: <?php echo get_theme_mod('carl_body_link_active', '#FFE600'); ?>;
		}
		...
		.slicknav li.menu-item, .slicknav .slick-head {
			...
			border: 1px solid <?php echo get_theme_mod('carl_slicknav_border', true); ?>;
